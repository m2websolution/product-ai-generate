...
export function buildProductFaqPrompt({ title, description, language = "English", count = 5 }) {
  return {
    systemPrompt: "You generate FAQ pairs for Shopify products. Return ONLY a raw JSON array — no markdown fences, no explanation.",
    prompt: `Generate exactly ${count} FAQ question-and-answer pairs for this product.
